...
CREATE INDEX IF NOT EXISTS idx_order_adjustments_restaurant ON order_adjustments(restaurant_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_order_adjustments_order ON order_adjustments(order_id);
CREATE INDEX IF NOT EXISTS idx_order_adjustment_items_adjustment ON order_adjustment_items(adjustment_id);
